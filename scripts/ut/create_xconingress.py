...
def create_xcon_object(xcon_id):
    ...
    xcon_config.base_config.aid.value = "1-4-T3" + "," + "1-4-L1-1-ODU4i-" + str(xcon_id)
    xcon_config.config.source.value = "1-4-T3"
    xcon_config.config.destination.value = "1-4-L1-1-ODU4i-" + str(xcon_id)
