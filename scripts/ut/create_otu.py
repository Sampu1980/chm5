...
def create_otu_object(otu_id):
    ...
    otu_config.config.config_svc_type = sys_constants_pb2.BandWidth.BAND_WIDTH_100GB_ELAN
    otu_config.config.service_mode = sys_constants_pb2.ServiceMode.SERVICE_MODE_SWITCHING
    otu_config.config.otu_ms_config.fac_ms.forced_ms = sys_constants_pb2.MAINTENANCE_ACTION_SENDAIS
    otu_config.config.otu_ms_config.fac_ms.auto_ms = sys_constants_pb2.MAINTENANCE_ACTION_SENDOCI
    otu_config.config.otu_ms_config.term_ms.forced_ms = sys_constants_pb2.MAINTENANCE_ACTION_NOREPLACE
    otu_config.config.otu_ms_config.term_ms.auto_ms = sys_constants_pb2.MAINTENANCE_ACTION_PRBS_X31
    otu_config.config.loopback = sys_constants_pb2.LoopbackType.LOOPBACK_TYPE_TERMINAL
    otu_config.config.loopback_behavior = sys_constants_pb2.TERM_LOOPBACK_BEHAVIOR_BRIDGESIGNAL
    #otu_config.config.otu_prbs_config.fac_prbs_gen.value = True
    #otu_config.config.otu_prbs_config.fac_prbs_mon.value = False
    #otu_config.config.otu_prbs_config.term_prbs_gen.value = True
    #otu_config.config.otu_prbs_config.term_prbs_mon.value = False
    otu_config.config.otu_prbs_config.fac_prbs_gen_bool = infn_datatypes_pb2.BOOL_TRUE
    otu_config.config.otu_prbs_config.fac_prbs_mon_bool = infn_datatypes_pb2.BOOL_FALSE
    otu_config.config.otu_prbs_config.term_prbs_gen_bool = infn_datatypes_pb2.BOOL_TRUE
