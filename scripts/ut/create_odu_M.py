...
def create_odu_object(odu_id):
    ...
    odu_config.base_config.aid.value = "1-7-T" + str(odu_id)
    odu_config.config.odu_index.value = int(odu_id) 
    odu_config.config.config_svc_type = sys_constants_pb2.BandWidth.BAND_WIDTH_ODU4
    ...
    odu_config.config.odu_prbs_config.fac_prbs_mon_bool = infn_datatypes_pb2.BOOL_FALSE
    odu_config.config.odu_prbs_config.term_prbs_gen_bool = infn_datatypes_pb2.BOOL_FALSE
    odu_config.config.odu_prbs_config.term_prbs_mon_bool = infn_datatypes_pb2.BOOL_FALSE
    odu_config.config.service_mode = sys_constants_pb2.ServiceMode.SERVICE_MODE_SWITCHING
    odu_config.config.odu_ms_config.fac_forceaction = sys_constants_pb2.MAINTENANCE_ACTION_NOREPLACE
    odu_config.config.odu_ms_config.fac_autoaction = sys_constants_pb2.MAINTENANCE_ACTION_SENDAIS
    odu_config.config.odu_ms_config.term_forceaction = sys_constants_pb2.MAINTENANCE_ACTION_NOREPLACE
    odu_config.config.odu_ms_config.term_autoaction = sys_constants_pb2.MAINTENANCE_ACTION_SENDAIS
