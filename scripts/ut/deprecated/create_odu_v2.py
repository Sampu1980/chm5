...
def create_odu_object(odu_id):
    ...
    odu_config.hal.odu_ms_config.fac_forceaction = sys_constants_pb2.MAINTENANCE_ACTION_SENDAIS
    odu_config.hal.odu_ms_config.fac_autoaction = sys_constants_pb2.MAINTENANCE_ACTION_SENDOCI
    odu_config.hal.odu_ms_config.term_forceaction = sys_constants_pb2.MAINTENANCE_ACTION_SENDLCK
    odu_config.hal.odu_ms_config.term_autoaction = sys_constants_pb2.MAINTENANCE_ACTION_SENDAIS
