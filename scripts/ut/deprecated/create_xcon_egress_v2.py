...
def create_xcon_object(xcon_id):
    ...
    xcon_config.base_config.config_id.value = "1-4-T5,1-4-L1-1-ODU4i-" + str(xcon_id)
    xcon_config.hal.source.value = "1-4-T5"
    xcon_config.hal.destination.value = "1-4-L1-1-ODU4i-" + str(xcon_id)
