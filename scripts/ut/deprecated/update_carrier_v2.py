...
def update_carrier_object(car_id):
    ...
    car_config.hal.mode.application_code.value = "newAppCode"
    car_config.hal.mode.baud_rate.value = 9
    car_config.hal.mode.capacity.value = 8
    car_config.hal.mode.client = sys_constants_pb2.CLIENT_MODE_LXTP_M
    car_config.hal.enable.value = False 
    
    # Why below causing problem? todo: look into it
