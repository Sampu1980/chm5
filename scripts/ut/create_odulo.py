...
def create_odu_object(odu_id):
    ...
    odu_config.config.odu_prbs_config.fac_prbs_gen_bool = infn_datatypes_pb2.BOOL_TRUE
    odu_config.config.odu_prbs_config.fac_prbs_mon_bool = infn_datatypes_pb2.BOOL_FALSE
    odu_config.config.odu_prbs_config.term_prbs_gen_bool = infn_datatypes_pb2.BOOL_TRUE
    ...
    odu_config.config.odu_ms_config.term_autoaction = sys_constants_pb2.MAINTENANCE_ACTION_NOREPLACE
